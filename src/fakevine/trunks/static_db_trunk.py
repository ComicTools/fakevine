...
class StaticDBTrunk(ComicTrunk):
    ...
    def _generate_multi_response(self, params: api.FilterParams, db_table: type[db.BaseTable], api_model: type[api.BaseModelExtra],
    ...
    def _get_character_data(self, db_record: db.Character, field_list: list[str]) -> dict:  # noqa: C901, PLR0912
        response_dict = {}
    ...
    def _get_issue_data(self, db_record: db.Issue, field_list: list[str]) -> dict:  # noqa: C901
    ...
    def _get_location_data(self, db_record: db.Location, field_list: list[str]) -> dict:
        direct_copy_fields = [*self._base_entity_fields]
    ...
    def _get_object_data(self, db_record: db.Object, field_list: list[str]) -> dict:
        direct_copy_fields = [*self._base_entity_fields]
    ...
    def _get_origin_data(self, db_record: db.Origin, field_list: list[str]) -> dict:
    ...
    def _get_person_data(self, db_record: db.Person, field_list: list[str]) -> dict:
    ...
    def _get_power_data(self, db_record: db.Power, field_list: list[str]) -> dict:
    ...
    def _get_publisher_data(self, db_record: db.Publisher, field_list: list[str]) -> dict:
    ...
    def _get_team_data(self, db_record: db.Team, field_list: list[str]) -> dict:
        direct_copy_fields = [*self._base_entity_fields]
    ...
    def _get_volume_data(self, db_record: db.Volume, field_list: list[str]) -> dict:
